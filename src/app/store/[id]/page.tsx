...
import { ArrowRight, ShoppingCart, Star, MapPin, Clock, Heart } from 'lucide-react';
...
const productFilters = ['الكل', 'الأكثر طلباً', 'مفضلاتي', 'لحوم', 'أرز', 'وجبات سريعة', 'مشروبات', 'سلطات'];
