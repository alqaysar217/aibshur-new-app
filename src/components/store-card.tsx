  ...
  return (
    <Link href={`/store/${id}`} className="block">
      <Card className="shadow-sm hover:shadow-md transition-shadow bg-card overflow-hidden">
        <CardContent className="p-1.5 flex h-full items-center gap-3">
          <div className="relative w-24 h-24 flex-shrink-0 group">
            ...
            />
             <div className="absolute inset-0 rounded-lg border-2 border-primary/20 group-hover:shadow-[0_0_12px_2px] group-hover:shadow-primary/40 transition-all duration-300"></div>
          </div>
